 ...
 */
define( 'WP_TESTS_DIR', '/Users/tareq/Sites/wordpress-develop/tests/phpunit/' );

/**
 * The path to the main file of the plugin to test.
 */
define( 'TEST_PLUGIN_FILE', '/Users/tareq/Sites/wprepo/plugins/wpuf-user-listing/userlisting.php' );
