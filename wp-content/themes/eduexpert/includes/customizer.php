...
add_action( 'customize_register', 'eduexpert_customize_register' );
function eduexpert_customize_register( $wp_customize ) {
	
	//$wp_customize->get_section( 'header_image' )->panel = 'eduexpert_header_panel';
	...
	$wp_customize->add_panel( 'header_top_panel', array(
		'title' => __( 'Header Top Section', 'eduexpert' ),
		'description' => __( 'Change the font size and color for Site Title, Site Tagline and Menu', 'eduexpert' ), // Include html tags such as <p>.
		'priority' => 1, // Mixed with top-level-section hierarchy.
		) );
		
		//Site Title section
		$wp_customize->add_section( 'site_title_section', array(
			'title' => __( 'Site Title' , 'eduexpert' ),
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'site_title_color', array(
					...
					'label' => __( 'Color', 'eduexpert' ),
					'description' => __( 'Change color of site title', 'eduexpert' ),
					) )
				);
		
		//Site Tagline section
		$wp_customize->add_section( 'site_tagline_section', array(
			'title' => __( 'Site Tagline' , 'eduexpert' ),
			'panel' => 'header_top_panel',
			'priority' => 2,
			'capability' => 'edit_theme_options',
			) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'tagline_color', array(
					...
					'label' => __( 'Color', 'eduexpert' ),
					'description' => __( 'Change color of site tagline', 'eduexpert' ),
					) ) );
			
	/*--- Header Banner ---*/
	$wp_customize->add_panel( 'header_banner', array(
		'title' => __( 'Header Banner', 'eduexpert' ),
		'description' => __( 'Change the font size and color for Site Title, Site Tagline and Menu', 'eduexpert' ),
		'priority' => 2,
		) );
	
		//Banner type section
		$wp_customize->add_section( 'banner_type_section', array(
			'title' => __( 'Banner Type' , 'eduexpert' ),
			'panel' => 'header_banner',
			'priority' => 1,
			'capability' => 'edit_theme_options',
			) );
			...
			$wp_customize->add_control( 'banner_type', array(
				...
				'label' => __( 'Fron page banner type', 'eduexpert' ),
				'description' => __( 'Select banner type for front page', 'eduexpert' ),
				'choices' => array(
					'bg-color' => __( 'Background Color', 'eduexpert' ),
					'bg-gradient' => __( 'Background Gradient', 'eduexpert' ),
					'image' => __( 'Background Image', 'eduexpert' ),
					'video' => __( 'Background Video', 'eduexpert' ),
				),
				) );
			...
			$wp_customize->add_control( 'banner_height', array(
				...
				'label' => __( 'Height of banner (Default: 700px)', 'eduexpert' ),
				'input_attrs' => array(
					'min' => 0,
					'max' => 2000,
					'step' => 1,
		...
		$wp_customize->add_section( 'banner_bg_color_section', array(
			'title' => __( 'Banner Background: Color' , 'eduexpert' ),
			'panel' => 'header_banner',
			'priority' => 2,
			'capability' => 'edit_theme_options',
			) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'banner_bg_color', array(
					...
					'label' => __( 'Background Color', 'eduexpert' ),
					'description' => __( 'Change background color of banner', 'eduexpert' ),
				) ) );
			
		//Banner background Gradient section
		$wp_customize->add_section( 'banner_bg_gradient_section', array(
			'title' => __( 'Banner Background: Gradient' , 'eduexpert' ),
			'panel' => 'header_banner',
			'priority' => 3,
			'capability' => 'edit_theme_options',
			'description' => __( 'Choose the colors below to give gradient background to your banner', 'eduexpert' ),
			) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'banner_bg_gradient_1', array(
					...
					'label' => __( 'Gradient color 1', 'eduexpert' ),
					'description' => __( 'Add 1st Gradient color', 'eduexpert' ),
					) ) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'banner_bg_gradient_2', array(
					...
					'label' => __( 'Gradient color 2', 'eduexpert' ),
					'description' => __( 'Add 2nd Gradient color', 'eduexpert' ),
					) ) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'banner_bg_gradient_3', array(
					...
					'label' => __( 'Gradient color 3', 'eduexpert' ),
					'description' => __( 'Add 3rd Gradient color', 'eduexpert' ),
					) ) );
		
		//Banner background image section
		$wp_customize->add_section( 'banner_bg_img_section', array(
			'title' => __( 'Banner Background: Image' , 'eduexpert' ),
			'panel' => 'header_banner',
			'priority' => 4,
			'capability' => 'edit_theme_options',
			'description' => __( 'Upload image and set other settings for banner background', 'eduexpert' ),
			) );
			...
			$wp_customize->add_control( new WP_Customize_Image_Control(
				$wp_customize, 'banner_bg_img', array(
					...
					'label' => __( 'Upload image for background', 'eduexpert' ),
					) ) );
			...
			$wp_customize->add_control( 'banner_bg_size', array(
				...
				'label' => __( 'Banner background size', 'eduexpert' ),
				'choices' => array(
					'cover' => __( 'cover', 'eduexpert' ),
					'contain' => __( 'contain', 'eduexpert' ),
				),
				) );
			...
			$wp_customize->add_control( 'banner_bg_pos', array(
				...
				'label' => __( 'Banner background position', 'eduexpert' ),
				'choices' => array(
					'top-left' => __( 'top left', 'eduexpert' ),
					'top-center' => __( 'top center', 'eduexpert' ),
					'top-right' => __( 'top right', 'eduexpert' ),
					'center-left' => __( 'center left', 'eduexpert' ),
					'center-center' => __( 'center center', 'eduexpert' ),
					'center-right' => __( 'center right', 'eduexpert' ),
					'bottom-left' => __( 'bottom left', 'eduexpert' ),
					'bottom-center' => __( 'bottom center', 'eduexpert' ),
					'bottom-right' => __( 'bottom right', 'eduexpert' ),
				),
				) );
			...
			$wp_customize->add_control( 'banner_bg_repeat', array(
				...
				'label' => __( 'Banner background no-repeat', 'eduexpert' ),
				) );
			
		//Banner content section
		$wp_customize->add_section( 'banner_content_section', array(
			'title' => __( 'Banner content' , 'eduexpert' ),
			'panel' => 'header_banner',
			'priority' => 5,
			'capability' => 'edit_theme_options',
			'description' => __( 'Form here you can change the text of all titles, subititle and paragraph present on banner', 'eduexpert' ),
			) );
		
			//Banner main title
			$wp_customize->add_setting( 'banner_main_title', array(
				'capability' => 'edit_theme_options',
				'default' => __( 'Hospital that you can trust', 'eduexpert' ),
				'transport' => 'refresh',
			...
			$wp_customize->add_control( 'banner_main_title', array(
				...
				'label' => __( 'Banner main title', 'eduexpert' ),
				) );
			...
			$wp_customize->add_control( 'banner_sub_title', array(
				...
				'label' => __( 'Banner sub title', 'eduexpert' ),
				) );
			
			//Banner paragraph
			$wp_customize->add_setting( 'banner_para', array(
				'capability' => 'edit_theme_options',
				'default' => __( 'Looking for an Electrician', 'eduexpert' ),
				'transport' => 'refresh',
				'sanitize_callback' => 'wp_filter_nohtml_kses',
				) );
			...
			$wp_customize->add_control( 'banner_para', array(
				...
				'label' => __( 'Banner paragraph', 'eduexpert' ),
				) );
			
			//Banner button1 text
			$wp_customize->add_setting( 'banner_btn1_txt', array(
				'capability' => 'edit_theme_options',
				'default' => __( 'Ready to get started', 'eduexpert' ),
				'transport' => 'refresh',
				'sanitize_callback' => 'wp_filter_nohtml_kses',
				) );
			...
			$wp_customize->add_control( 'banner_btn1_txt', array(
				...
				'label' => __( 'Banner 1st button text', 'eduexpert' ),
				) );
			
			//Banner button1 url
			$wp_customize->add_setting( 'banner_btn1_url', array(
				'capability' => 'edit_theme_options',
				'default' => __( '#', 'eduexpert' ),
				'transport' => 'refresh',
				'sanitize_callback' => 'wp_filter_nohtml_kses',
				) );
			...
			$wp_customize->add_control( 'banner_btn1_url', array(
				...
				'label' => __( 'Banner 1st button url', 'eduexpert' ),
				) );
			
			//Banner button2 text
			$wp_customize->add_setting( 'banner_btn2_txt', array(
				'capability' => 'edit_theme_options',
				'default' => __( 'Learn More', 'eduexpert' ),
				'transport' => 'refresh',
				'sanitize_callback' => 'wp_filter_nohtml_kses',
				) );
			...
			$wp_customize->add_control( 'banner_btn2_txt', array(
				...
				'label' => __( 'Banner 2nd button text', 'eduexpert' ),
				) );
			...
			$wp_customize->add_control( 'banner_btn2_url', array(
				...
				'label' => __( 'Banner 2nd button url', 'eduexpert' ),
				) );
			...
			$wp_customize->add_control( new WP_Customize_Image_Control(
				$wp_customize, 'banner_side_img', array(
					...
					'label' => __( 'Upload side image for banner', 'eduexpert' ),
					) ) ); */
				
	
	/*--- General settings ---*/
	$wp_customize->add_panel( 'general_settings', array(
		'title' => __( 'General settings', 'eduexpert' ),
		'priority' => 3,
		) );
		
		//Page padding section
		$wp_customize->add_section( 'page_padding', array(
			'title' => __( 'Main page padding' , 'eduexpert' ),
			'panel' => 'general_settings',
			'priority' => 1,
			'capability' => 'edit_theme_options',
			'description' => __( 'Form here you can change the top and bottom padding of page', 'eduexpert' ),
			) );
			...
			$wp_customize->add_control( 'page_top_padding', array(
				...
				'label' => __( 'Space between header and page content (in px)', 'eduexpert' ),
				'input_attrs' => array(
					'min' => 0,
					'max' => 500,
					'step' => 1,
			...
			$wp_customize->add_control( 'page_bottom_padding', array(
				...
				'label' => __( 'Space between footer and page content (in px)', 'eduexpert' ),
				'input_attrs' => array(
					'min' => 0,
					'max' => 500,
					'step' => 1,
	...
	$wp_customize->add_panel( 'theme_blog_panel', array(
		'title' => __( 'Blogs Panel', 'eduexpert' ),
		'priority' => 4,
		) );
		
		//Blog layout
		$wp_customize->add_section( 'theme_blog_layout', array(
			'title' => __( 'Blog layout' , 'eduexpert' ),
			...
			$wp_customize->add_control( 'theme_blog_type', array(
				...
				'label' => __( 'Select blog layout', 'eduexpert' ),
				'description' => __( 'This will change the styling of blogs on blog and single blog page', 'eduexpert' ),
				'choices' => array(
					'default' => __( 'Default', 'eduexpert' ),
					'special' => __( 'Special', 'eduexpert' ),
				),
				) );
			...
			$wp_customize->add_control( 'show_sidebar', array(
				...
				'label' => __( 'Check this box to show sidebar on blogs page', 'eduexpert' ),
				) );
			...
			$wp_customize->add_control( 'show_sidebar_single', array(
				...
				'label' => __( 'Check this box to show sidebar on single blog page', 'eduexpert' ),
				) );
	...
	/*--- Colors panel ---*/		
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'primary_color', array(
					...
					'label' => __( 'Primary color', 'eduexpert' ),
					'description' => __( 'Change in this color will change the primary color of whole theme', 'eduexpert' ),
					) ) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'theme_text_color', array(
					...
					'label' => __( 'Theme text color', 'eduexpert' ),
					'description' => __( 'Change in this color will change the text color of whole theme (basically all paragraphs).', 'eduexpert' ),
					) ) );
					
			// Register upsell
        	$wp_customize->register_section_type( 'EduExpert_Upsell' );
        	class EduExpert_Upsell extends WP_Customize_Section {
                public $type = 'upsell';
                public $url = '';
        		public $text = '';
        	...
        	$wp_customize->add_section( new EduExpert_Upsell( $wp_customize, 'upsell', array(
        		'title' => __('upsell', 'eduexpert'),
                'text' => 'Pro Features',
                'url' => 'https://suavethemes.com/details/corporate/eduexpert-pro'
                //'priority' => 0
                ) )
            );				
}
...
function twx_sntz_banner_type( $value ){
	$valid = array(
        'bg-color' => __( 'Color', 'eduexpert' ),
		'bg-gradient' => __( 'Gradient', 'eduexpert' ),
		'image' => __( 'Image', 'eduexpert' ),
		'video' => __( 'Video', 'eduexpert' ),
		'carousel' => __( 'Background Carousel', 'eduexpert' ),
	);
	return ( array_key_exists( $value, $valid ) ? $value : '' );
}

function eduexpert_sanitize_menu( $value ){
	$valid = array(
		'sticky'   => __('Sticky', 'eduexpert'),
		'static'   => __('Static', 'eduexpert'),
	);
	return ( array_key_exists( $value, $valid ) ? $value : '' );
}
...
function eduexpert_sanitize_widget_area($value){
	$valid = array(
		'1'     => __('One', 'eduexpert'),
		'2'     => __('Two', 'eduexpert'),
		'3'     => __('Three', 'eduexpert'),
		'4'     => __('Four', 'eduexpert')
	);
	return ( array_key_exists( $value, $valid ) ? $value : '' );
}

function eduexpert_sanitize_wc_content($value){
	$valid = array(
		'left'    => __('Left', 'eduexpert'),
		'right'     => __('Right', 'eduexpert'),
	);
	return ( array_key_exists( $value, $valid ) ? $value : '' );
}

function eduexpert_sanitize_image( $input ){
